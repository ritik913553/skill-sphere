...
const links = [
  { name: "My Groups", href: "/dashboard/my-groups", icon: Briefcase },
  { name: "Find Mentors", href: "/dashboard/find-mentors", icon: BookOpen },
  { name: "Become Mentor", href: "/dashboard/become-mentor", icon: Newspaper },
  { name: "Find Project", href: "/dashboard/find-project", icon: Newspaper },
  { name: "Resources", href: "/dashboard/resources", icon: Newspaper },
];
